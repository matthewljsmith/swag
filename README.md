...
[![GoDoc](https://godoc.org/github.com/matthewljsmith/swag?status.svg)](https://godoc.org/github.com/matthewljsmith/swag)
...
```bash
go get github.com/matthewljsmith/swag
```
...
Refer to the [godoc](https://godoc.org/github.com/matthewljsmith/swag/endpoint) for a list of all the endpoint options
